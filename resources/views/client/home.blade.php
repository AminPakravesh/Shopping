                                            ...
                                            <div class="owl-item active" style="width: 309.083px; margin-left: 10px;">
                                                <div class="item">
                                                    ...
                                                    @if($product->discount()->exists())
                                                        <span
                                                            class="save-price">{{$product->discount->value}} % تخفیف </span>
                                                    @endif
                                                    <h2 class="post-title">
                                                        <a href="{{route('client.products.show',$product)}}">
                                                            {{$product->name}}
                                                    ...
                                                    <div class="price">
                                                        @if ($product->has_discount)
                                                            <del><span>{{$product->cost}}<span>تومان</span></span></del>
                                                            <ins>
                                                                <span>{{$product->cost_with_discount}}<span>تومان</span></span>
                                                            </ins>
                                                        @else
                                                            <ins>
                                                                <span>{{$product->cost_with_discount}}<span>تومان</span></span>
                                                    ...
                                                    <div class="actions">
                                                        <ul>
                                                            ...
                                                            <li class="action-item add-to-cart">
                                                                <button onclick="addToCart({{$product->id}});" title="افزودن به سبد خرید" class="btn btn-light btn-add-to-cart"
                                                                        type="submit">
                                                                    <i class="fa fa-shopping-cart"></i>
                                                                </button>
                                                            </li>
