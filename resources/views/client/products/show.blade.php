                                        ...
                                        <div class="gallery-item">
                                            <div>
                                                <ul class="gallery-actions">
                                                    <li>
                                                        <a href="#" id="like-{{$product->id}}" class="btn-option add-product-wishes" onclick="like({{$product->id}});">
                                                            <i class="mdi mdi-heart-outline @if($product->is_liked) like @endif" ></i>
                                                            <span>محبوب</span>
                                                        </a>
                                                    </li>
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        ...
                                                                        <div class="form-auth-row">
                                                                            ...
                                                                            <label for="remember"
                                                                                   class="remember-me mr-0">سیستم پیام
                                                                                شخصی
                                                                                کالامارکت</label>
                                                                        </div>
                                                                    </div>
                                                                    <div class="modal-footer">
                                                                        <button type="button"
                                                                                class="btn btn-primary ml-2">ثبت
                                                                        </button>
                                                                ...
                                                                <div class="modal-content">
                                                                    <div class="modal-body">
                                                                        <div id="custom-events">
                                                                            <a
                                                                                href="/client/images/page-single-product/product-img/product-img-note10.jpg">
                                                                                <img
                                                                                    src="/client/images/page-single-product/product-img/product-img-note10.jpg"/>
                                                                            </a>
                                                                            <a
                                                                                href="/client/images/page-single-product/product-img/product-img-note10-big-1.jpg">
                                                                                <img
                                                                                    src="/client/images/page-single-product/product-img/product-img-note10-big-1.jpg"/>
                                                                            </a>
                                                                            <a
                                                                                href="/client/images/page-single-product/product-img/product-img-note10-big-2.jpg">
                                                                                <img
                                                                                    src="/client/images/page-single-product/product-img/product-img-note10-big-2.jpg"/>
                                                                            </a>
                                                                            <a
                                                                                href="/client/images/page-single-product/product-img/product-img-note10-big-3.jpg">
                                                                                <img
                                                                                    src="/client/images/page-single-product/product-img/product-img-note10-big-3.jpg"/>
                                                                            </a>
                                                                            <a
                                                                                href="/client/images/page-single-product/product-img/product-img-note10-big-4.jpg">
                                                                                <img
                                                                                    src="/client/images/page-single-product/product-img/product-img-note10-big-4.jpg"/>
                                                                            </a>
                                                                            <a
                                                                                href="/client/images/page-single-product/product-img/product-img-note10-big-5.jpg">
                                                                                <img
                                                                                    src="/client/images/page-single-product/product-img/product-img-note10-big-5.jpg"/>
                                                                            </a>
                                                                            <a
                                                                                href="/client/images/page-single-product/product-img/product-img-note10-big-6.jpg">
                                                                                <img
                                                                                    src="/client/images/page-single-product/product-img/product-img-note10-big-6.jpg"/>
                                                                            </a>
                                                                            <a
                                                                                href="/client/images/page-single-product/product-img/product-img-note10-big-7.jpg">
                                                                                <img
                                                                                    src="/client/images/page-single-product/product-img/product-img-note10-big-7.jpg"/>
                                                                            </a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <li class="item">
                                                        <a href="#" class="elevatezoom-gallery active" data-update=""
                                                           ...
                                                           data-zoom-image="{{str_replace('public' , '/storage' , $product->image)}}">
                                                            <img
                                                                src="{{str_replace('public' , '/storage' , $product->image)}}"
                                                                width="100%" style="border-radius: 3px"/></a>
                                                    </li>
                                            ...
                                            <div class="seller-info-changable">
                                                ...
                                                <div class="product-seller-row price">
                                                    ...
                                                    <a href="#" class="product-name">
                                                        ...
                                                        @if ($product->has_discount)
                                                            <del style="color: red">
                                                                <span>{{$product->cost}}<span>تومان</span></span></del>
                                                            <span class="amount">
                                                ...
                                                <div class="product-seller-row guarantee">
                                                    ...
                                                    <div class="quantity pl">
                                                        <input id="inpute-quantity" type="number" min="1" max="100" step="1" value="1">
                                                ...
                                                <div class="product-seller-row add-to-cart">
                                                    <a href="#" class="btn-add-to-cart btn btn-primary">
                                                        <span class="btn-add-to-cart-txt" onclick="addToCart({{$product->id}});">
                                                            افزودن به سبد خرید
                                                        </span>
                                                    </a>
                                                </div>
                            ...
                            <div class="product-feature">
                                <div class="product-feature-col">
                                    <a href="#" class="product-feature-item">
                                        <img src="/client/images/page-single-product/delivery.svg">
                                        امکان تحویل
                                        <br>
                                        اکسپرس
                                    </a>
                                ...
                                <div class="product-feature-col">
                                    <a href="#" class="product-feature-item">
                                        <img src="/client/images/page-single-product/contact-us.svg">
                                        ۷ روز هفته
                                        <br>
                                        ۲۴ ساعته
                                    </a>
                                ...
                                <div class="product-feature-col">
                                    <a href="#" class="product-feature-item">
                                        <img src="/client/images/page-single-product/payment-terms.svg">
                                        امکان
                                        <br>
                                        پرداخت در محل
                                    </a>
                                ...
                                <div class="product-feature-col">
                                    <a href="#" class="product-feature-item">
                                        <img src="/client/images/page-single-product/return-policy.svg">
                                        هفت روز ضمانت بازگشت کالا
                                    </a>
                                </div>
                                <div class="product-feature-col">
                                    <a href="#" class="product-feature-item">
                                        <img src="/client/images/page-single-product/origin-guarantee.svg">
                                        ضمانت
                                        <br>
                                        اصل بودن کالا
                                    </a>
                    ...
                    <div class="tabs-content">
                        <div class="tab-content" id="myTabContent">
                                    ...
                                    <section class="content-expert-article">
                                        ...
                                        <div class="content-expert-text">
                                            ...
                                            <div class="content-expert-img">
                                                <img src="/client/images/page-single-product/tab-content/note10-1.jpg">
                                            </div>
                                        </div>
                                    </section>
                                    <section class="content-expert-article">
                                        ...
                                        <div class="content-expert-text">
                                            ...
                                            <div class="content-expert-img">
                                                <img src="/client/images/page-single-product/tab-content/note10-2.jpg">
                                            </div>
                                            ...
                                            <div class="content-expert-img">
                                                <img src="/client/images/page-single-product/tab-content/note10-3.jpg">
                                            </div>
                                            <p style="text-align:right">نمایشگر نوت 10 هم از فناوری همیشه روشن سود
                                                ...
                                                10 هستند.</p>
                                            <div class="content-expert-img">
                                                <img src="/client/images/page-single-product/tab-content/note10-4.jpg">
                                            </div>
                                        </div>
                                    </section>
                                    <section class="content-expert-article">
                                        ...
                                        <div class="content-expert-text">
                                            ...
                                            <div class="content-expert-img">
                                                <img src="/client/images/page-single-product/tab-content/note10-5.jpg">
                                            </div>
                                            ...
                                            <div class="content-expert-img">
                                                <img src="/client/images/page-single-product/tab-content/note10-6.jpg">
                                            </div>
                                                ...
                                                <li class="params-list-item">
                                                    ...
                                                    <div class="params-list-value">
                                                        @foreach($group->properties as $property)
                                                            <span class="block">
                                                                {{$property->title}} :  {{$property->getValueForProduct($product)}}
                                                            </span>
                                                        @endforeach
                                                    </div>
                                                </li>
                            ...
                            <div class="tab-pane fade" id="question-and-answer" role="tabpanel"
                                ...
                                <div class="faq">
                                    <h2 class="params-headline">پرسش و پاسخ {{$product->comments->count()}}
                                    ...
                                    @auth()
                                        ...
                                        <form action="{{route('client.products.comments.store',$product)}}" class="form-faq" method="post">
                                            @csrf
                                            <div class="form-faq-row mt-4">
                                                <div class="form-faq-col">
                                                    <div class="ui-textarea">
                                                    <textarea id="content" name="content" title="متن سوال"
