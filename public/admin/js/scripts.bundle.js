...
$(document).ready(function() {
    $('#files_list').DataTable({
        ...
        "language": {
            ...
            "sLengthMenu": "تعداد _MENU_ ایتم",
            "sZeroRecords": "هیچ رکوردی وجود ندارد",
            "sInfo": "از _START_ تا _END_ نمایش میدهد و  _TOTAL_ ایتم دارید",
            "sInfoEmpty": "از 0 تا 0 نمایش میدهد 0 ایتم دارید",
            "sInfoFiltered": "(مجموعا _MAX_ دارید)",
            "sInfoPostFix": "",
            "sSearch": "سرچ:",
            "sUrl": "",
            "oPaginate": {
